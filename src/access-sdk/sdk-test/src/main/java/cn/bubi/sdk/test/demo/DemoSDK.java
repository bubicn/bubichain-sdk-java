...
import cn.bubi.sdk.test.TestConfig;
import cn.bubi.sdk.test.bo.Parameter;
...
public class DemoSDK{
    ...
    public static void configSdk() throws SdkException{
        ...
        DemoSDK.operationService = config.getOperationService();
        DemoSDK.queryService = config.getQueryService();
    }
